...
const appId = channel === "prod" ? "com.innexarcode.desktop" : `com.innexarcode.desktop.${channel}`
const productName = channel === "prod" ? "InnexarCode" : `InnexarCode ${channel.charAt(0).toUpperCase() + channel.slice(1)}`
...
<component type="desktop-application">
  ...
  <description>
    <p>
      InnexarCode is an AI coding agent that helps you write and run code with any AI model.
    </p>
  </description>
