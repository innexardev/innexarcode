...
// pins still resolve after the canonical app id changes back to com.innexarcode.desktop.
...
const getBase = (appId: string): Configuration => ({
  ...
  // not just the app id. For prod, app id "com.innexarcode.desktop" becomes
  // "com.innexarcode.desktop.desktop".
