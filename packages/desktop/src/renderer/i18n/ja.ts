export const dict = {
  ...
  "desktop.updater.none.message": "すでに最新バージョンの InnexarCode を使用しています",
  ...
  "desktop.updater.downloaded.prompt":
    "InnexarCode のバージョン {{version}} がダウンロードされました。インストールして再起動しますか？",
  ...
  "desktop.cli.installed.message":
    "CLI を {{path}} にインストールしました\n\nターミナルを再起動して 'innexarcode' コマンドを使用してください。",
