export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من InnexarCode",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من InnexarCode، هل ترغب في تثبيته وإعادة تشغيله؟",
